...
$sql = "INSERT INTO tblclasses(ClassName, ClassNameNumeric, Year, Section) VALUES(:classname, :classnamenumeric, :year, :section)";
...
<div class="form-group has-success">
<label for="success" class="control-label">Class Numeric</label>
<div class="">
...
<div class="">
<input type="text" name="year" required="required" class="form-control" id="success">

...
$sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.Semester,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.StudentEmail,tblstudents.MobileNo,tblstudents.Gender,tblclasses.ClassName,tblclasses.ClassNameNumeric,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
...
<div class="col-sm-10">
<input type="text" name="sem" class="form-control" id="sem" value="<?php echo htmlentities($result->Semester)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="mobile" name="mobileno" class="form-control" id="tel" value="<?php echo htmlentities($result->MobileNo)?>" required="required" autocomplete="off">
</div>
</div>

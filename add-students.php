...
$classid = $_POST['class'];
$status = 1;
$sql = "INSERT INTO  tblstudents(StudentName,RollId,Semester,StudentEmail,MobileNo,Gender,ClassId,Status) VALUES(:studentname,:roolid,:semester,:studentemail,:mobileno,:gender,:classid,:status)";
...
maxlength="80" required="required" autocomplete="off">
</div>
</div>
...
Year-<?php echo htmlentities($result->Year); ?>&nbsp;
Sem-<?php echo htmlentities($result->Section); ?>
</option>
<?php }
} ?>
</select>
...
<div class="col-sm-10">
<input type="tel" name="mobileno" class="form-control" id="mobile"
required="required" autocomplete="off">
</div>
</div>

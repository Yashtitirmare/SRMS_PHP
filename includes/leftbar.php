...
<ul class="child-nav">
<li><a href="create-tattendance.php"><i class="fa fa-bars"></i> <span>Create Attendance</span></a></li>
<li><a href="manage-tattendance.php"><i class="fa fa-bars"></i> <span>Manage Attendance</span></a></li>


</ul>        </li>

<li class="has-children">
<a href="#"><i class="fa fa-file-text"></i> <span>Exams</span> <i class="fa fa-angle-right arrow"></i></a>
<ul class="child-nav">
<li><a href="create-exam.php"><i class="fa fa-bars"></i> <span>Create Exams</span></a></li>
<li><a href="manage-exams.php"><i class="fa fa fa-server"></i> <span>Manage Exams</span></a></li>
...
<li><a href="add-attendance.php"><i class="fa fa-bars"></i> <span>Declare Attendance</span></a></li>
<li><a href="manage-attendance.php"><i class="fa fa fa-server"></i> <span>Manage Declare Attendance</span></a></li>

</ul>        </li>

<li class="has-children">
<a href="#"><i class="fa fa-info-circle"></i> <span>Gadget</span> <i class="fa fa-angle-right arrow"></i></a>
<ul class="child-nav">
<li><a href="learner.php"><i class="fa fa-bars"></i> <span>Learner Report</span></a></li>
<li><a href="pass-fail.php"><i class="fa fa fa-server"></i> <span>Pass and Fail Report</span></a></li>
...
<ul class="child-nav">
<li><a href="learner-category-count.php"><i class="fa fa-bars"></i> <span>Learner Category Report</span></a></li>
<li><a href="reports.php"><i class="fa fa-bars"></i> <span>Reports</span></a></li>

...
$sql="update  tblclasses set ClassName=:classname,ClassNameNumeric=:classnamenumeric,Year=:year,Section=:section where id=:cid ";
...
<span class="help-block">Eg- MCA, BCA, etc</span>
</div>
</div>
<div class="form-group has-success">
<label for="success" class="control-label">Class Code</label>
<div class="">
<input type="text" name="classnamenumeric" value="<?php echo htmlentities($result->ClassNameNumeric);?>" required="required" class="form-control" id="success" readonly>
...
<span class="help-block">Eg- I,II,III etc</span>
</div>
</div>
<?php }} ?>
<div class="form-group has-success">

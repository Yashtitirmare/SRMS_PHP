...
$marks=$_POST['marks'];
$sql="INSERT INTO  tblexams(ExamName,ExamsNameNumeric,ExamCode, Marks) VALUES(:examname,:examsnamenumeric,:examcode, :marks)";
...
<title>SMS Admin Create Exams</title>
...
<div class="col-md-6">
<h2 class="title">Create Student Exams</h2>
</div>
...
<div class="">
<input type="number" name="examsnamenumeric" required="required" class="form-control" id="success">
...
<div class="">
<input type="text" name="examcode" class="form-control" required="required" id="success">
...
<div class="">
<input type="text" name="marks" class="form-control" required="required" id="success">

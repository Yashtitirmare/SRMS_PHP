...
$sql="INSERT INTO  tbltattendance(AttendanceName,AttendanceNameNumeric,AttendanceCode, TotalAttendance) VALUES(:attendancename,:attendancenamenumeric,:attendancecode, :totalattendance)";
...
<title>SMS Admin Create Attendance</title>
...
<div class="col-md-6">
<h2 class="title">Create Class Attendance</h2>
</div>
...
<div class="">
<input type="text" name="attendancename" class="form-control" required="required" id="success">
...
<div class="">
<input type="number" name="attendancenamenumeric" required="required" class="form-control" id="success">
...
<div class="">
<input type="text" name="attendancecode" class="form-control" required="required" id="success">
...
<div class="">
<input type="text" name="totalattendance" class="form-control" required="required" id="success">
